...
/**
 * A custom variant on ObjectLongOrderedMap that always uses enum keys, which simplifies some operations.
 */
public class EnumLongOrderedMap<K extends Enum<K>> extends ObjectLongOrderedMap<K> {
