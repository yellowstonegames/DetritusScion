...
/**
 * A custom variant on ObjectLongMap that always uses enum keys, which simplifies some operations.
 */
public class EnumLongMap<K extends Enum<K>> extends ObjectLongMap<K> {
